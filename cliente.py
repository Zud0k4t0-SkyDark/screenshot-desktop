...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
 ...
 #   print ("\nMensaje del Servidor:\n\n==> {}\n".format((data.decode("utf-8")).strip()))
    ...
    clear_screen()
    print ("[blue italic]{}[/blue italic]".format(d.center(40,"~")))
    ascii_string()
    def menu():
        print ('''[green italic]
        ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣴⣾⠿⠿⠿⠿⠿⠿⠿⠿⢷⣦⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
        ...
        if data_Send == "1":
            ...
            while True:
                ...
                if data_option == "1":
                    ...
                    clear_screen()
                    try:
                        print ("[red][[/red][yellow italic]![/yellow italic][red]][/red] [green italic]Subject[/green italic]")
                        subject = input("\n==> ")
                        s.send(b'continue')
                        ...
                        clear_screen()
                        print ("\n[red][[/red][yellow italic]![/yellow italic][red]][/red] [yellow italic]Hemos perdido la Conexión[/yellow italic] [cyan italic]:([/cyan italic]")
                elif data_option == "4":
                    try:
                    ...
                    print ("\n[red][[/red][yellow italic]![/yellow italic][red]][/red] [yellow]Enter a number[yellow] [purple]\/0-0\/[/purple]\n")
                # Recived Status Image
